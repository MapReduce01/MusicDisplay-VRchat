...
__all__ = [
    'UIA_ListControlTypeId', 'ScrollAmount_LargeIncrement',
    'UIA_ScrollBarControlTypeId',
    'IUIAutomationNotificationEventHandler',
    'IUIAutomationRangeValuePattern', 'UIA_CustomLandmarkTypeId',
    'IUIAutomation2', 'IUIAutomationTransformPattern2',
    'UIA_NamePropertyId', 'UIA_LegacyIAccessibleStatePropertyId',
    'AutomationElementMode_Full',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_SelectionActiveEndAttributeId', 'UIA_CustomControlTypeId',
    'UIA_MarginTrailingAttributeId',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_DataItemControlTypeId',
    'UIA_Window_WindowOpenedEventId', 'UIA_CheckBoxControlTypeId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_AcceleratorKeyPropertyId', 'StyleId_Heading2',
    'UIA_FillColorPropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_TransformPattern2Id', 'IUIAutomationScrollPattern',
    'IUIAutomationElement8', 'SupportedTextSelection',
    ...
    'UIA_ChangesEventId', 'IUIAutomationTogglePattern',
    'UIA_AppBarControlTypeId', 'UIA_MenuControlTypeId',
    'UIA_IsSuperscriptAttributeId', 'TreeScope',
    'AnnotationType_Unknown', 'UIA_TextPattern2Id',
    'IUIAutomationAnnotationPattern', 'UIA_FontWeightAttributeId',
    'IUIAutomationSpreadsheetPattern',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_GridItemPatternId', 'IUIAutomationProxyFactoryEntry',
    'UIA_WindowIsTopmostPropertyId', 'IUIAutomationProxyFactory',
    'SynchronizedInputType_KeyUp', 'AnnotationType_GrammarError',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_TextChildPatternId', 'UIA_AnnotationAuthorPropertyId',
    'TextEditChangeType_None', 'UIA_FullDescriptionPropertyId',
    'NotificationProcessing_ImportantAll', 'UIA_EditControlTypeId',
    'UIA_ItemStatusPropertyId', 'ToggleState_Off',
    'UIA_IsDataValidForFormPropertyId', 'UIA_Invoke_InvokedEventId',
    'ToggleState', 'UIA_RangeValueSmallChangePropertyId',
    'IUIAutomationTextRange2', 'StyleId_Emphasis',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_SelectionPatternId',
    'UIA_Transform2ZoomMinimumPropertyId',
    'IUIAutomationVirtualizedItemPattern', 'WindowInteractionState',
    ...
    'UIA_MultipleViewPatternId', 'UIA_CustomNavigationPatternId',
    'UIA_StyleIdAttributeId', 'WindowVisualState_Minimized',
    'UIA_AriaRolePropertyId', 'SynchronizedInputType_LeftMouseUp',
    'NavigateDirection_FirstChild',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_StyleNameAttributeId',
    'UIA_TableItemRowHeaderItemsPropertyId', 'TreeScope_Ancestors',
    'UIA_SystemAlertEventId', 'StyleId_Normal',
    'UIA_IsActiveAttributeId', 'IUIAutomationTextPattern',
    'IUIAutomationTreeWalker', 'IUIAutomationObjectModelPattern',
    'IUIAutomationSelectionItemPattern',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_ComboBoxControlTypeId', 'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_ImageControlTypeId', 'UIA_TableRowOrColumnMajorPropertyId',
    'TextUnit_Page', 'UIA_RadioButtonControlTypeId',
    'UIA_LinkAttributeId', 'StructureChangeType_ChildRemoved',
    'UIA_ToolTipOpenedEventId', 'StyleId_Heading9',
    'UIA_StylesPatternId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_IsPasswordPropertyId', 'ScrollAmount',
    'StyleId_BulletedList', 'UIA_SynchronizedInputPatternId',
    'UIA_DescribedByPropertyId', 'NavigateDirection',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_LegacyIAccessibleValuePropertyId', 'UIA_CapStyleAttributeId',
    'TextPatternRangeEndpoint', 'ZoomUnit',
    'WindowInteractionState_Running', 'CoalesceEventsOptions',
    'UIA_IsOffscreenPropertyId',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_AnnotationPatternId',
    'StructureChangeType', 'IUIAutomationTableItemPattern',
    ...
    'UIA_OverlineColorAttributeId', 'HeadingLevel7',
    'UIA_InvokePatternId', 'AnnotationType_UnsyncedChange',
    'UIA_ControlTypePropertyId', 'NotificationKind',
    'UIA_AsyncContentLoadedEventId', 'UIA_SelectionPattern2Id',
    'UIA_AnnotationTypesPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'IUIAutomationFocusChangedEventHandler', 'AnnotationType_Footer',
    'UIA_LineSpacingAttributeId', 'ScrollAmount_SmallIncrement',
    'UIA_TableColumnHeadersPropertyId', 'UIA_Drag_DragCancelEventId',
    'UIA_AnnotationObjectsAttributeId', 'UIA_TogglePatternId',
    'UIA_ToggleToggleStatePropertyId', 'UIA_IsItalicAttributeId',
    'UIA_IndentationTrailingAttributeId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_WindowPatternId', 'UIA_LocalizedControlTypePropertyId',
    'TreeTraversalOptions_Default', 'AnnotationType_ExternalChange',
    'UIA_AnnotationTargetPropertyId', 'WindowVisualState_Normal',
    'UIA_DragIsGrabbedPropertyId', 'ZoomUnit_NoAmount',
    'OrientationType', 'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_TransformPatternId', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_DropTarget_DragEnterEventId',
    'ConnectionRecoveryBehaviorOptions',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_ProcessIdPropertyId', 'TextUnit_Word',
    'ZoomUnit_LargeIncrement', 'IUIAutomationSelectionPattern2',
    'UIA_AccessKeyPropertyId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_TabControlTypeId', 'AnnotationType_Footnote',
    'UIA_DockPatternId', 'UIA_AnnotationTypesAttributeId',
    'DockPosition_Top', 'IUIAutomationEventHandler',
    'UIA_StylesStyleNamePropertyId', 'UIA_HeaderControlTypeId',
    'UIA_TransformCanMovePropertyId', 'IUIAutomationGridItemPattern',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'IUIAutomationValuePattern', 'TextEditChangeType_AutoCorrect',
    'UIA_ExpandCollapsePatternId', 'IUIAutomationTextPattern2',
    'UIA_FontNameAttributeId', 'UIA_GridItemRowPropertyId',
    'NotificationKind_Other', 'UIA_RotationPropertyId',
    'TreeScope_Descendants', 'StyleId_NumberedList',
    'PropertyConditionFlags', 'UIA_StrikethroughColorAttributeId',
    'UIA_ItemContainerPatternId', 'StyleId_Heading7',
    'IUIAutomationElement2', 'AnnotationType_ConflictingChange',
    'AnnotationType_InsertionChange', 'UIA_ValueValuePropertyId',
    'UIA_DropTarget_DragLeaveEventId', 'UIA_HelpTextPropertyId',
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_ToolBarControlTypeId',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_TransformCanRotatePropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'RowOrColumnMajor_ColumnMajor', 'OrientationType_Vertical',
    'UIA_BoundingRectanglePropertyId',
    'IUIAutomationDropTargetPattern',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_IsHiddenAttributeId', 'UIA_ProviderDescriptionPropertyId',
    ...
    'IUIAutomationTextRange3', 'SynchronizedInputType',
    ...
    'UIA_StylesStyleIdPropertyId', 'UIA_MarginLeadingAttributeId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'TextUnit',
    'UIA_SpreadsheetPatternId', 'HeadingLevel6',
    'UIA_SpreadsheetItemPatternId',
    'UIA_MultipleViewCurrentViewPropertyId', 'Polite',
    'IUIAutomationTextChildPattern', 'AutomationElementMode_None',
    'AnnotationType_FormatChange', 'UIA_InputReachedTargetEventId',
    'DockPosition_Right', 'IUIAutomationNotCondition',
    'IUIAutomationInvokePattern',
    'IUIAutomationPropertyChangedEventHandler',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_ToolTipClosedEventId', 'UIA_UnderlineColorAttributeId',
    'UIA_LiveSettingPropertyId', 'UIA_MenuModeStartEventId',
    'UIA_SearchLandmarkTypeId', 'IUIAutomationEventHandlerGroup',
    'IUIAutomation4', 'IUIAutomationElement4',
    'UIA_DropTargetDropTargetEffectsPropertyId', 'HeadingLevel_None',
    'UIA_OrientationPropertyId', 'IUIAutomation5',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'ProviderOptions_OverrideProvider',
    'UIA_LegacyIAccessiblePatternId', 'UIA_CaretBidiModeAttributeId',
    'UIA_GridColumnCountPropertyId', 'IUIAutomationTextRangeArray',
    'UIA_MarginBottomAttributeId', 'Off', 'ProviderOptions',
    'UIA_ProgressBarControlTypeId', 'UIA_MenuOpenedEventId',
    'TreeScope_Subtree', 'IUIAutomationProxyFactoryMapping',
    'UIA_SelectionItemIsSelectedPropertyId', 'TextUnit_Format',
    'UIA_SplitButtonControlTypeId', 'UIA_ItemTypePropertyId',
    'UIA_DockDockPositionPropertyId', 'NotificationProcessing_All',
    'StyleId_Heading6', 'ProviderOptions_NonClientAreaProvider',
    'UIA_ToolTipControlTypeId',
    'TreeTraversalOptions_LastToFirstOrder',
    'SupportedTextSelection_Single', 'UIA_WindowIsModalPropertyId',
    'UIA_RangeValueValuePropertyId', 'IUIAutomationTransformPattern',
    'IUIAutomationOrCondition',
    'WindowInteractionState_NotResponding',
    'UIA_OutlineStylesAttributeId', 'UIA_BackgroundColorAttributeId',
    'RowOrColumnMajor_Indeterminate', 'ExpandCollapseState',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'IUIAutomationSynchronizedInputPattern', 'TextUnit_Character',
    'AnnotationType_Highlighted',
    'UIA_IsInvokePatternAvailablePropertyId',
    'IUIAutomationTextEditPattern', 'UIA_IsRequiredForFormPropertyId',
    ...
    'IUIAutomationElement', 'AnnotationType_EditingLockedChange',
    'UIA_IsDropTargetPatternAvailablePropertyId', 'DockPosition_Fill',
    'UIA_LabeledByPropertyId', 'TextUnit_Paragraph',
    'ScrollAmount_NoAmount', 'UIA_TabItemControlTypeId',
    'AutomationElementMode', 'DockPosition_Left',
    ...
    'UIA_OverlineStyleAttributeId', 'UIA_VisualEffectsPropertyId',
    'UIA_BulletStyleAttributeId', 'UIA_IsControlElementPropertyId',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_Drag_DragCompleteEventId',
    'UIA_GridItemContainingGridPropertyId', 'UIA_TabsAttributeId',
    'AnnotationType_MoveChange', 'ExtendedProperty',
    'UIA_RangeValueMinimumPropertyId', 'HeadingLevel4',
    'UIA_SelectionItemPatternId', 'IUIAutomationPropertyCondition',
    'UIA_TreeControlTypeId', 'AnnotationType_TrackChanges',
    'UIA_IsDragPatternAvailablePropertyId',
    'AnnotationType_SpellingError',
    'UIA_ScrollVerticalViewSizePropertyId',
    'NotificationKind_ActionCompleted', 'HeadingLevel5',
    'ZoomUnit_SmallDecrement', 'TreeScope_Children',
    'UIA_LiveRegionChangedEventId',
    'IUIAutomationMultipleViewPattern', 'AnnotationType_Sensitive',
    'UIA_NativeWindowHandlePropertyId', 'UIA_ScrollItemPatternId',
    ...
    'IUIAutomationSelectionPattern', 'CoalesceEventsOptions_Disabled',
    'DockPosition_None', 'AnnotationType_DeletionChange',
    'IUIAutomationItemContainerPattern', 'UIA_TitleBarControlTypeId',
    'UIA_SpinnerControlTypeId', 'IUIAutomationScrollItemPattern',
    'UIA_MarginTopAttributeId', 'ExpandCollapseState_Collapsed',
    'SynchronizedInputType_RightMouseUp', 'UIA_ListItemControlTypeId',
    'ZoomUnit_SmallIncrement', 'UIA_SizePropertyId',
    'UIA_PaneControlTypeId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_RuntimeIdPropertyId', 'NotificationKind_ItemAdded',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId', 'UIA_ScrollPatternId',
    'UIA_ControllerForPropertyId', 'UIA_DragPatternId',
    'StructureChangeType_ChildAdded', 'AnnotationType_Author',
    'UIA_SelectionSelectionPropertyId', 'UIA_StylesShapePropertyId',
    'UIA_InputReachedOtherElementEventId',
    'UIA_GridItemColumnPropertyId', 'AnnotationType_Header',
    'IUIAutomationElement7', 'IUIAutomation',
    'UIA_AnnotationObjectsPropertyId', 'UIA_GroupControlTypeId',
    'UIA_OutlineColorPropertyId', 'UIA_ObjectModelPatternId',
    'UIA_DropTarget_DroppedEventId', 'UIA_StylesFillColorPropertyId',
    'IUIAutomationElement5',
    'UIA_IsSelectionPatternAvailablePropertyId', 'TextEditChangeType',
    'CoalesceEventsOptions_Enabled',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'ToggleState_On', 'UIA_SizeOfSetPropertyId',
    'NavigateDirection_PreviousSibling', 'IRawElementProviderSimple',
    ...
    'TextEditChangeType_Composition', 'UIA_GridPatternId',
    'StyleId_Heading1', 'UIA_ActiveTextPositionChangedEventId',
    'IUIAutomationGridPattern', 'ToggleState_Indeterminate',
    'RowOrColumnMajor', 'UIA_SemanticZoomControlTypeId',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomationCondition', 'UIA_PositionInSetPropertyId',
    'UIA_CaretPositionAttributeId', 'IAccessible',
    'RowOrColumnMajor_RowMajor', 'IUIAutomationElementArray',
    'UIA_IsTransformPatternAvailablePropertyId', 'HeadingLevel1',
    'UIA_CalendarControlTypeId', 'UIA_FlowsToPropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_IsContentElementPropertyId', 'StyleId_Heading5',
    'IUIAutomation3', 'UIA_TextFlowDirectionsAttributeId',
    'UIA_StatusBarControlTypeId', 'UIA_IsPeripheralPropertyId',
    'StyleId_Heading3', 'PropertyConditionFlags_IgnoreCase',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_IsDialogPropertyId', 'UIA_TextControlTypeId',
    'WindowInteractionState_BlockedByModalWindow',
    'StructureChangeType_ChildrenBulkAdded', 'DockPosition_Bottom',
    'SupportedTextSelection_None', 'AnnotationType_Mathematics',
    'IUIAutomationCacheRequest', 'UIA_TextEditPatternId',
    'UIA_Text_TextSelectionChangedEventId', 'UIA_FontSizeAttributeId',
    ...
    'UIA_GridRowCountPropertyId', 'UIA_HeaderItemControlTypeId',
    'UIA_NavigationLandmarkTypeId', 'UIA_DropTargetPatternId',
    'StyleId_Custom', 'UIA_NotificationEventId',
    'UIA_MenuBarControlTypeId', 'NotificationProcessing_MostRecent',
    'UIA_ClickablePointPropertyId', 'TextUnit_Document',
    'ProviderOptions_UseComThreading',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'AnnotationType_Endnote', 'IUIAutomationTextRange',
    ...
    'TextEditChangeType_AutoComplete', 'StyleId_Heading8',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_Text_TextChangedEventId', 'UIA_FormLandmarkTypeId',
    'UIA_DragDropEffectPropertyId', 'UIA_TableItemPatternId',
    'WindowVisualState_Maximized', 'UIA_OutlineThicknessPropertyId',
    'TextPatternRangeEndpoint_Start', 'IUIAutomationWindowPattern',
    'UIA_DocumentControlTypeId', 'IUIAutomationDockPattern',
    'IUIAutomationBoolCondition', 'UIA_LevelPropertyId',
    'UIA_HyperlinkControlTypeId', 'HeadingLevel8',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_GridItemRowSpanPropertyId', 'NotificationKind_ItemRemoved',
    'UIA_DragGrabbedItemsPropertyId', 'TreeTraversalOptions',
    'UIA_IsGridPatternAvailablePropertyId', 'LiveSetting',
    'UIA_MenuClosedEventId', 'UIA_IsTablePatternAvailablePropertyId',
    'UIA_CenterPointPropertyId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'SynchronizedInputType_KeyDown',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'AnnotationType_Comment', 'UIA_WindowControlTypeId',
    'TreeScope_Parent', 'TreeScope_Element', 'IUIAutomationElement3',
    'IUIAutomationTablePattern',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_Drag_DragStartEventId', 'UIA_TablePatternId',
    'NotificationProcessing', 'UIA_MainLandmarkTypeId',
    'UIA_TextPatternId', 'HeadingLevel3', 'UIA_IsReadOnlyAttributeId',
    'UIA_ThumbControlTypeId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId', 'OrientationType_None',
    'ScrollAmount_LargeDecrement', 'WindowVisualState',
    'UIA_FlowsFromPropertyId', 'UIA_RangeValueMaximumPropertyId',
    'NavigateDirection_NextSibling', 'DockPosition',
    'StyleId_Heading4', 'Assertive', 'IUIAutomationElement6',
    'UIA_Transform2CanZoomPropertyId',
    'UIA_WindowCanMinimizePropertyId', 'IUIAutomationElement9',
    'UIA_Transform2ZoomMaximumPropertyId', 'UiaChangeInfo',
    ...
    'UIA_DropTargetDropTargetEffectPropertyId', 'CUIAutomation',
    'ExpandCollapseState_LeafNode', 'UIA_VirtualizedItemPatternId',
    'UIA_SliderControlTypeId', 'NavigateDirection_LastChild',
    'UIA_AnimationStyleAttributeId', 'UIA_AriaPropertiesPropertyId',
    'AnnotationType_DataValidationError', 'NavigateDirection_Parent',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'PropertyConditionFlags_None', 'UIA_LayoutInvalidatedEventId',
    'UIA_Window_WindowClosedEventId', 'IUIAutomation6',
    'HeadingLevel9', 'ZoomUnit_LargeDecrement',
    'UIA_AnnotationDateTimePropertyId',
    'TextPatternRangeEndpoint_End', 'NotificationKind_ActionAborted',
    'UIA_RangeValuePatternId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_ButtonControlTypeId', 'StyleId_Quote', 'UIA_SummaryChangeId',
    'UIA_HeadingLevelPropertyId', 'ExpandCollapseState_Expanded',
    'UIA_DataGridControlTypeId', 'IUIAutomationDragPattern',
    'UIA_SeparatorControlTypeId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'TextUnit_Line', 'NotificationProcessing_ImportantMostRecent'
]

_check_version('1.2.0', 1657290265.462847)
